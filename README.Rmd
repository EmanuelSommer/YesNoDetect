...
- The application is hosted free of charge via shinyapps.io and thus requires quite some time to launch.
- The application is built as a desktop application and thus is not fully operational on touchscreens.
